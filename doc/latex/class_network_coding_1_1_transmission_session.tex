...
\end{DoxyReturn}
Start retransmission timeout if the packet is F\+L\+A\+G\+S\+\_\+\+E\+N\+D\+\_\+\+O\+F\+\_\+\+B\+LK.

Schedule ack timeout for both original and network coding packets.\index{Network\+Coding\+::\+Transmission\+Session@{Network\+Coding\+::\+Transmission\+Session}!Process\+Data\+Ack@{Process\+Data\+Ack}}
...
\item[\hyperlink{todo__todo000003}{Todo}]Retransmission can be further optimized by using loss rate. E.\+g., we can immediately transmit encoded packet at the end of transmission without waiting the ack. \end{DoxyRefDesc}
...
\hline
\end{DoxyParams}
\index{Network\+Coding\+::\+Transmission\+Session@{Network\+Coding\+::\+Transmission\+Session}!Push\+Data\+Packet@{Push\+Data\+Packet}}
...
\hline
\end{DoxyParams}
We do not count retransmission packets as unacked packet. Retransmission is transmitted regardless of m\+\_\+\+Bytes\+Unacked.\index{Network\+Coding\+::\+Transmission\+Session@{Network\+Coding\+::\+Transmission\+Session}!Send\+Ping@{Send\+Ping}}
